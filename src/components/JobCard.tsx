...
const JobCard = ({
  ...
  const content = (
    <div
      className={cn(
        "flex w-full cursor-pointer items-center justify-between rounded-md border-2 bg-card px-5 py-3 hover:bg-muted/60 hover:no-underline data-[state=open]:rounded-b-none data-[state=open]:bg-muted/60",
        className
      )}
    >
      <div className="flex flex-col items-start justify-start gap-2">
        ...
        <div className="flex items-center justify-start gap-2">
          <Badge variant="outline">
            ...
            <span className="text-xs">{jobOffer.modality}</span>
          </Badge>
          <Badge variant="outline">
            <span className="text-xs">{jobOffer.seniority}</span>
          </Badge>
          <Badge variant="outline">
          ...
          <Badge variant="outline">
            <span className="text-xs">{jobOffer.contractType}</span>
          </Badge>
          <Badge variant="outline">
            <Watch className="mr-1 size-4 stroke-primary" />
            <span className="text-xs">{jobOffer.startDate}</span>
          </Badge>
        </div>
      </div>
  ...
  return isAccordion ? (
    <AccordionTrigger asChild>{content}</AccordionTrigger>
  ) : (
    content
  );
};
